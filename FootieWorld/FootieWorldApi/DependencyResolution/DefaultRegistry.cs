...
namespace FootieWorldApi.DependencyResolution {
    ...
    public class DefaultRegistry : Registry {
        ...
        public DefaultRegistry() {
            ...
            For<IUnitOfWork>().Use<UnitOfWork>().Ctor<DbContext>().Is(new FootieDbEntities());
            For<IStadiumService>().Use<StadiumService>();
        }
